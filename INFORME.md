...
| Repositorio GitHub | https://github.com/cefer181/proyecto-final-devops |
| Repositorio Docker Hub | https://hub.docker.com/r/cefer181/devops-final-project |
...
## 5. Comandos utilizados para crear la estructura
...
git init
git branch -M main
git config user.name "Cesar Jacome"
...
## 9. Creación del versionamiento con release
...
```bash
git remote add origin https://github.com/cefer181/proyecto-final-devops.git
```
...
## 11. Configuración de GitHub Actions
    ...
    steps:
      ...
      - name: Construir y publicar imagen Docker
        ...
        with:
          ...
          file: ./Dockerfile
          push: true
          tags: cefer181/devops-final-project:v1
```
...
```text
https://hub.docker.com/r/cefer181/devops-final-project
```
...
```bash
docker run -d \
  --name devops-final-project-grupo1 \
  -p 8001:8000 \
...
```text
cefer181/devops-final-project   v1   IMAGE_ID   CREATED   SIZE
```

---

## 15. Verificación del contenedor
...
```json
{
    ...
    "group": {
        "name": "Grupo 1",
        "members": "César Jácome, Marcela Baldeón"
    }
}
```
...
![Figura 1. Página de inicio del contenedor](docs/capturas/figura_01_pagina_inicio_contenedor.png)

### Figura 2. Validación de imagen publicada en Docker Hub

![Figura 2. Imagen publicada en Docker Hub](docs/capturas/figura_03_imagen_publicada_dockerhub.png)
...
- Se publicó la imagen `cefer181/devops-final-project:v1` en Docker Hub.
